...
def main(args):
    ...
    alg_options = {'K': kNNSolution, 'S': greedySFS, 'C': antColony,
                   'M':antMaxMin}
    alg_names = {'K': "KNN", 'S': "SFS", 'C': "SCH", 'M':"SHMM"}
    ...
    parser.add_argument('-a', choices=['K','S','C','M'],
                        help='Algorithm to use. K -> kNN; S -> greedy SFS; C -> ant colony; M -> ant Max-Min',
                        default='K')
