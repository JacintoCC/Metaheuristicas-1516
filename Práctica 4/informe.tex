...
\title{	Práctica 4 Metaheurísticas.\\
		Optimización basada en colonias de hormigas \\
		para el problema de la selección de características}
...
% Tablas SCH-BL
\pgfplotstableread[col sep=comma]{Software/Resultados/wSCH.csv}\datawSCH
\pgfplotstableread[col sep=comma]{Software/Resultados/lSCH.csv}\datalSCH
\pgfplotstableread[col sep=comma]{Software/Resultados/aSCH.csv}\dataaSCH

% Tablas SHMM-BL
\pgfplotstableread[col sep=comma]{Software/Resultados/wSHMM.csv}\datawSHMM
\pgfplotstableread[col sep=comma]{Software/Resultados/lSHMM.csv}\datalSHMM
\pgfplotstableread[col sep=comma]{Software/Resultados/aSHMM.csv}\dataaSHMM
...
\begin{enumerate}
\item Algoritmo de Sistema de Colonias de Hormigas
\item Algoritmo Sistema de Hormigas Max-Mín
\end{enumerate}
...
\subsubsection{Algoritmo basado en colonia de hormigas}
% Tablas Resumen SCH
\makeresume{\dataSCH}{\datawSCH}{\datalSCH}{\dataaSCH}
...
\subsubsection{Algoritmo basado en hormigas Max-Mín}
% Tablas Resumen SHMM
\makeresume{\dataSHMM}{\datawSHMM}{\datalSHMM}{\dataaSHMM}
