...
\subsection{Extended Tabu Search}
% Tablas Resumen ETS
...
\item Para realizar las tablas \href{https://www.complang.tuwien.ac.at/doc/texlive-pictures-doc/latex/pgfplots/pgfplotstable.pdf}{Manual PGFPLOTSTABLE}
\end{itemize}
\end{document}
